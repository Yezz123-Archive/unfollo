...
var=$(
    curl -i -s -H "$header" https://i.instagram.com/api/v1/si/fetch_headers/?challenge_type=signup &
    guid=$uuid >/dev/null
)
...
banner() {
    ...
    printf " \e[1;93m| | | |             / _|     | | |                \e[1;92m\e[0m\n"
    printf " \e[1;93m| | | |_ __    __   | |_ ___ | | | ___ \e[1;92m \e[0m\n"
    printf " \e[1;93m| | | | '_ \   __   |  _/ _ \| | |/ _ \   \e[1;92m  \e[0m\n"
    printf " \e[1;93m| |_| | | | |  __   | || (_) | | | (_) |     \e[1;92m   \e[0m\n"
...
user_login() {
    ...
    if [[ -e .cookie.$user ]]; then
        ...
        if [[ $var == "challenge" ]]; then
            ...
            exit 1
        elif [[ $var == "logged_in_user" ]]; then printf " \e[1;96m[\e[0m\e[1;97m+\e[0m\e[1;96m]\e[0m\e[1;92m Successfully Logged in !\e[0m\n"; elif [[ $var == "Please wait" ]]; then echo " Please wait"; fi
...
menu() {
    ...
    if [[ $option == 1 || $option == 01 ]]; then
        ...
        xdg-open https://github.com/yezz123/
        sleep 2
        exit 1
